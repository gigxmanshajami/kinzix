                ...
                <div  className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-6 max-w-[1240px]">
                    ...
                    {services.map((service, i) => (
                        <div
                            ...
                            className={`service-card ${service.bg} ${service.text} border-[#191A23] border-[0.9px] border-b-[7px] border-solid rounded-[45px] p-6 lg:w-[461px] h-[255px] flex flex-row justify-between w-[359px]`}
                        >
