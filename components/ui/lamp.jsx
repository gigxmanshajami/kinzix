    ...
    <div
      ...
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-[#0e1519] via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-[#0e1519] text-white [--conic-position:from_290deg_at_center_top]">
          <div
